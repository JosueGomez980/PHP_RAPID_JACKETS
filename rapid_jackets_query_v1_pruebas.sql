...
SELECT * FROM PEDIDO_ENTREGA WHERE DATE(FECHA_SOLICITUD) = (ADDDATE(CURDATE(), INTERVAL -1 DAY));
...
SELECT * FROM PEDIDO_ENTREGA WHERE WEEK(FECHA_SOLICITUD) = WEEK(NOW()) ORDER BY FECHA_SOLICITUD DESC ;
