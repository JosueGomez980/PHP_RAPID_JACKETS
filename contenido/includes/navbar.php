<nav class="navbar m-nav is-navbar-XD">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="registro_usuarios.php" class="is-hover-Color12 w3-center"><span class="glyphicon glyphicon-user"></span> Resgistrate</a></li>
                <li><a href="iniciar_sesion.php" class="is-hover-Color26 w3-center"><span class="glyphicon glyphicon-log-in"></span> Iniciar Sesion</a></li>
            </ul>
        </div>
    </nav>
